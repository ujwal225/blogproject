                    ...
                    <div class="card-body">
                        ...
                        @endif
                            <table class="table table-bordered">
                                ...
                                @foreach($records as $iteration => $record)
                                    <tr>
                                        <td>{{$iteration+1}}</td>
                                        <td>{{$record->postID->title}}</td>
                                        ...
                                        <td>
                                             <a href="{{route('backend.comment.show', $record->id)}}" class="btn btn-success">View</a>
                                             <a href="{{route('backend.comment.edit', $record->id)}}" class="btn btn-warning">Edit</a>
